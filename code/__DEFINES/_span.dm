...
#define span_speaker_event(str) ("<span class='yel'>" + str + "</span>")
#define span_speaker_text(str) ("<span class='yelBig'>" + str + "</span>")
#define span_speaker_name(str) ("<span class='yel'>" + str + "</span>")
