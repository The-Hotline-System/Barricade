...
DEFINE_BITFIELD(chemical_flags, list(
	...
	"REAGENT_SPECIAL" = REAGENT_SPECIAL,
...
DEFINE_BITFIELD(flags, list(
	...
	"KEEP_TIMING" = SS_KEEP_TIMING,
	"POST_FIRE_TIMING" = SS_POST_FIRE_TIMING,
	"HIBERNATE" = SS_HIBERNATE
))
...
DEFINE_BITFIELD(bodypart_flags, list(
	"BP_BLEEDING" = BP_BLEEDING,
	"BP_HAS_BLOOD" = BP_HAS_BLOOD,
	"BP_HAS_BONES" = BP_HAS_BONES,
	"BP_BROKEN_BONES" = BP_BROKEN_BONES,
	"BP_HAS_TENDON" = BP_HAS_TENDON,
	"BP_TENDON_CUT" = BP_TENDON_CUT,
	"BP_HAS_ARTERY" = BP_HAS_ARTERY,
	"BP_ARTERY_CUT" = BP_ARTERY_CUT,
	"BP_IS_GRABBY_LIMB" = BP_IS_GRABBY_LIMB,
	"BP_IS_MOVEMENT_LIMB" = BP_IS_MOVEMENT_LIMB,
	"BP_CUT_AWAY" = BP_CUT_AWAY,
))
...
DEFINE_BITFIELD(pockets, list(
	"LEFT" = PANTS_LEFT_POCKET,
	"RIGHT" = PANTS_RIGHT_POCKET,
	"BOTH" = PANTS_BOTH_POCKETS,
))
