...
GLOBAL_LIST_EMPTY(soundscapes_by_name)
GLOBAL_LIST_EMPTY(soundscapes_by_type)
...
/datum/soundscape/New()
	. = ..()
	GLOB.soundscapes_by_name[lowertext(name)] = src
	GLOB.soundscapes_by_type[type] = src

/datum/soundscape/nothing
	name = "nothing"
	dsp = 0
	playlooping = list()
	playrandom = list()
/*
/datum/soundscape/indoor/generic
	name = "indoor.generic"
	dsp = 1
	fadetime = 1.0
...
/datum/soundscape/outdoor/generic
...
/datum/soundscape/warfare/trench
	name = "warfare.trench"
	dsp = 1
	fadetime = 2.0
...
*/
/*
/datum/soundscape/warfare/battlefield
...
/datum/soundscape/warfare/bunker
	name = "warfare.bunker"
	dsp = 14
	fadetime = 1.0
...
/datum/soundscape/industrial/machinery
...
/datum/soundscape/industrial/generator
...
/datum/soundscape/nature/forest
	name = "nature.forest"
	dsp = 1
	fadetime = 2.0
...
/datum/soundscape/underground/cave
...
/datum/soundscape/underground/tunnel
...
/proc/init_soundscapes()
	// Initialize all soundscape datums
	new /datum/soundscape/nothing

	return
	/*
	new /datum/soundscape/indoor/generic
	new /datum/soundscape/outdoor/generic
	new /datum/soundscape/warfare/trench
	new /datum/soundscape/warfare/battlefield
	new /datum/soundscape/warfare/bunker
	new /datum/soundscape/industrial/machinery
	new /datum/soundscape/industrial/generator
	new /datum/soundscape/nature/forest
	new /datum/soundscape/nature/rain
	new /datum/soundscape/underground/cave
	new /datum/soundscape/underground/tunnel
	*/
