 ...
 *
 */
TYPEINFO_DEF(/obj/item/clothing/suit/space/space_ninja)
	default_armor = list(BLUNT = 40, PUNCTURE = 30, SLASH = 0, LASER = 20, ENERGY = 30, BOMB = 30, BIO = 30, FIRE = 100, ACID = 100)
