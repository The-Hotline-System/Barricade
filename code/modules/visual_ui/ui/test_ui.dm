...
/obj/abstract/visual_ui_element/scrollable/test_scroll/New(turf/loc, datum/visual_ui/P)
	...
	for(var/i = 1 to 25)
		...
		button.maptext = ("<span style='font-family: \"Blackmoor LET\", \"Pterra\";font-size: 150%;text-shadow: 1px 1px 2px black, 0 0 1em black, 0 0 0.2em black;'>BUTTON: [26-i]</span>")
		// MAPTEXT_CENTER("<span style='font-family: \"Blackmoor LET\", \"Pterra\";font-size: 150%;text-shadow: 1px 1px 2px black, 0 0 1em black, 0 0 0.2em black;'>BUTTON: [26-i]</span>")
