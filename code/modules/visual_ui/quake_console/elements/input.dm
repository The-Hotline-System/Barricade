...
/obj/abstract/visual_ui_element/console_input/UpdateIcon(appear = FALSE)
	...
	text_image.maptext = ("<span style='color:#00FF00'>>[display_text]</span>")
	 //MAPTEXT_VATICANUS("<span style='color:#00FF00'>>[display_text]</span>")
...
/obj/abstract/visual_ui_element/console_input/key_down(key, client/user)
	if(!focused)
		return FALSE
	return handle_keydown(key)

/obj/abstract/visual_ui_element/console_input/key_up(key, client/user)
	if(!focused)
		return FALSE
	return handle_keyup(key)
