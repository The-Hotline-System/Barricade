...
/mob/living/carbon/human/proc/copy_outfit()
	...
	var/list/slots_to_check = list(ITEM_SLOT_SHIRT,ITEM_SLOT_PANTS,ITEM_SLOT_BACK,ITEM_SLOT_OCLOTHING,ITEM_SLOT_BELT,ITEM_SLOT_GLOVES,ITEM_SLOT_FEET,ITEM_SLOT_HEAD,ITEM_SLOT_MASK,ITEM_SLOT_NECK,ITEM_SLOT_EARS,ITEM_SLOT_EYES,ITEM_SLOT_ID,ITEM_SLOT_SUITSTORE,ITEM_SLOT_LPOCKET,ITEM_SLOT_RPOCKET)
	...
	if(id_slot)
		...
		if(ID)
			...
			if(ID.template)
				O.id_template = ID.template.type
	//Copy hands
