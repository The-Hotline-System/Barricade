...
/client/verb/fit_viewport()
	...
	winset(src, "mainwindow.split", "splitter=70.6") // default values.
	winset(src, "infowindow.info", "splitter=30.8")

/client/proc/fullscreen_mode()
	src.toggle_fullscreeny(TRUE)
	winset(src, "mainwindow.split", "splitter=75")
	winset(src, "infowindow.info", "splitter=30")
